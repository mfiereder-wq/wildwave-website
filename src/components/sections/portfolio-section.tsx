...
const projects = [
  {
    ...
    image: '/images/jeshua-coiffeur.jpeg',
  ...
  },
  {
    ...
    title: 'SmartRank',
    category: 'Webdesign',
    description: 'Moderne Webapp für SEO-Ranking Analyse und Wettbewerbsbeobachtung mit Dashboard und Echtzeit-Daten',
    image: '/images/smartrank-project.png',
    results: 'Live Platform',
    tags: ['Webapp', 'React', 'Dashboard'],
    url: 'https://smartrank.live',
  },
  {
    id: 3,
    title: 'SinoQi',
